...
var gradDate = moment("12/15/2022").format("MMM Do, YYYY");
$("#1a").text(gradDate);
// bonus: 
$("#1a").append("<br/>Days Remaining: " + moment("12/15/2022", 'MM/DD/YYYY').diff(moment(), 'days'))//how many days left from today
// $("#1a").append("<br/>Days Remaining: " + moment("12/15/2022", 'MM/DD/YYYY').diff(moment("09/19/2022", 'MM/DD/YYYY'), 'days'));//days from start to end
